...
public class SeleniumTestNGDemoLinearDesign {
    ...
    public void RegisterUser() {
        ...
        signup.enterNameAndEmail("Yasmin", "yassmin.kamal@gmail.com");
        //Click 'Signup' button
        ...
        info.selectgender();
        info.InputPassword("12345");
        info.Selectdateofbirth("1", "January", "2021");
        //Select checkbox 'Sign up for our newsletter!'
        info.NewsletterCheckBox();
        //Select checkbox 'Receive special offers from our partners!'
        info.SpecialoffersCheckBox();
        //Fill details: First name, Last name, Company, Address, Address2, Country, State, City, Zipcode, Mobile Number.
        info.filldetails("Yasmin", "Mohamed", "GizaSystems", "October", "Haram", "Canada", "Ontario", "London", "000", "01114323232");
