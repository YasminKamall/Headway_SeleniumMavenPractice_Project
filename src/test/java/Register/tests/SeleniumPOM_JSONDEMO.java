...
import static framework.engine.DriverFactory.initDriver;


public class SeleniumPOM_JSONDEMO {
    ...
    public void RegisterUser() {
        ...
        info.filldetails(testData.getTestData("FirstName"), testData.getTestData("LastName"), testData.getTestData("Company"), testData.getTestData("Address1"), testData.getTestData("Address2"), testData.getTestData("Country"), testData.getTestData("State"), testData.getTestData("City"), testData.getTestData("ZipCode"), testData.getTestData("Mobile") );
